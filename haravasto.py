...
def lataa_kuvat(polku):
    ...
    kuvat["aloita"] = pyglet.resource.image("ruutu_aloita.png")
    kuvat["lopeta"] = pyglet.resource.image("ruutu_lopeta.png")
    kuvat["valmis"] = pyglet.resource.image("ruutu_valmis.png")
    kuvat["takaisin"] = pyglet.resource.image("ruutu_takaisin.png")
    kuvat["input"] = pyglet.resource.image("ruutu_input.png")
    kuvat["tilasto"] = pyglet.resource.image("ruutu_tilasto.png")
